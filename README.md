...
- Yenilikler / News (0.0.6-Beta):
  ...
  - [.subtract()](#subtract) metodundaki bazı hatalar düzeltildi.
    - Fixed some errors in the [.subtract()](#subtract) method.

- Yenilikler / News (0.0.5-Beta):
  - [unPush()](#unPush) methodu sonsuza kadar kaldırıldı.
    - The [unPush()](#unPush) method has been removed forever.
  - [arrayHas()](#arrayHas) methodu sonsuza kadar kaldırıldı.
    - The [arrayHas()](#arrayHas) method has been removed forever.
  ...
  - [Destek adresleri](#support) eklendi.
    - [Support addresses](#support) added.
